...
from improved_WOAmM import improved_WOAmM
import benchmark
import bound_X
import ideal_F
import dimension
...
for t in range(run_times):
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Sphere,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Rastrigin,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Ackley,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Griewank,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Schwefel_P222,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Rosenbrock,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Sehwwefel_P221,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Quartic,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Schwefel_P12,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Penalized1,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Penalized2,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Schwefel_226,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Step,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Kowalik,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.ShekelFoxholes,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.GoldsteinPrice,
    ...
    optimizer = improved_WOAmM(fitness=Shekel5,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Branin,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Hartmann3,
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = improved_WOAmM(fitness=Shekel7,
                               D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = improved_WOAmM(fitness=benchmark.Shekel,
                               D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    optimizer = improved_WOAmM(fitness=benchmark.SixHumpCamelBack,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Hartmann6,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Zakharov,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.SumSquares,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Alpine,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Michalewicz,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Exponential,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Schaffer,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.BentCigar,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Bohachevsky1,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Elliptic,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.DropWave,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.CosineMixture,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.Ellipsoidal,
    ...
    optimizer = improved_WOAmM(fitness=benchmark.LevyandMontalvo1,
...
loss_curves.columns = ['Sphere', 'Rastrigin', 'Ackley', 'Griewank', 'Schwefel P2.22',
                       ...
                       'Levy and Montalvo 1']
loss_curves.to_csv('loss_curves(improved_WOAmM).csv')
...
table.columns = ['Sphere', 'Rastrigin', 'Ackley', 'Griewank', 'Schwefel P2.22',
                 ...
                 'Bohachevsky 1', 'Elliptic', 'Drop Wave', 'Cosine Mixture', 'Ellipsoidal',
                 'Levy and Montalvo 1']
table.to_csv('table(improved_WOAmM).csv')