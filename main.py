...
for t in range(run_times):
    ...
    optimizer = WOAmM(fitness=benchmark.Sphere,
    ...
    optimizer = WOAmM(fitness=benchmark.Rastrigin,
    ...
    optimizer = WOAmM(fitness=benchmark.Ackley,
    ...
    optimizer = WOAmM(fitness=benchmark.Griewank,
    ...
    optimizer = WOAmM(fitness=benchmark.Schwefel_P222,
    ...
    optimizer = WOAmM(fitness=benchmark.Rosenbrock,
    ...
    optimizer = WOAmM(fitness=benchmark.Sehwwefel_P221,
    ...
    optimizer = WOAmM(fitness=benchmark.Quartic,
    ...
    optimizer = WOAmM(fitness=benchmark.Schwefel_P12,
    ...
    optimizer = WOAmM(fitness=benchmark.Penalized1,
    ...
    optimizer = WOAmM(fitness=benchmark.Penalized2,
    ...
    optimizer = WOAmM(fitness=benchmark.Schwefel_226,
    ...
    optimizer = WOAmM(fitness=benchmark.Step,
    ...
    optimizer = WOAmM(fitness=benchmark.Kowalik,
    ...
    optimizer = WOAmM(fitness=benchmark.ShekelFoxholes,
    ...
    optimizer = WOAmM(fitness=benchmark.GoldsteinPrice,
    ...
    optimizer = WOAmM(fitness=Shekel5,
    ...
    optimizer = WOAmM(fitness=benchmark.Branin,
    ...
    optimizer = WOAmM(fitness=benchmark.Hartmann3,
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = WOAmM(fitness=Shekel7,
                      D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    ub = bound_X.Shekel()[1]*np.ones(dimension.Shekel())
    lb = bound_X.Shekel()[0]*np.ones(dimension.Shekel())
    optimizer = WOAmM(fitness=benchmark.Shekel,
                      D=dimension.Shekel(), P=P, G=G, ub=ub, lb=lb)
    st = time.time()
    optimizer.opt()
    ed = time.time()
    ...
    optimizer = WOAmM(fitness=benchmark.SixHumpCamelBack,
    ...
    optimizer = WOAmM(fitness=benchmark.Hartmann6,
    ...
    optimizer = WOAmM(fitness=benchmark.Zakharov,
    ...
    optimizer = WOAmM(fitness=benchmark.SumSquares,
    ...
    optimizer = WOAmM(fitness=benchmark.Alpine,
    ...
    optimizer = WOAmM(fitness=benchmark.Michalewicz,
    ...
    optimizer = WOAmM(fitness=benchmark.Exponential,
    ...
    optimizer = WOAmM(fitness=benchmark.Schaffer,
    ...
    optimizer = WOAmM(fitness=benchmark.BentCigar,
    ...
    optimizer = WOAmM(fitness=benchmark.Bohachevsky1,
    ...
    optimizer = WOAmM(fitness=benchmark.Elliptic,
    ...
    optimizer = WOAmM(fitness=benchmark.DropWave,
    ...
    optimizer = WOAmM(fitness=benchmark.CosineMixture,
    ...
    optimizer = WOAmM(fitness=benchmark.Ellipsoidal,
    ...
    optimizer = WOAmM(fitness=benchmark.LevyandMontalvo1,
...
loss_curves.columns = ['Sphere', 'Rastrigin', 'Ackley', 'Griewank', 'Schwefel P2.22',
                       ...
                       'Levy and Montalvo 1']
loss_curves.to_csv('loss_curves(WOAmM).csv')
